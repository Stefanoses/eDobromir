...
define("tinymce/Editor", [
	...
	function Editor(id, settings, editorManager) {
		...
		/**
		 * Dom query instance with avatar scope to the editor document and avatar element is the body of the editor.
		 *
		 * @property $
	...
	Editor.prototype = {
		 ...
		 * @param {String} defaultVal Optional avatar value to retrieve.
		 */
		 ...
		 * @param {String} defaultVal Optional avatar value to return.
		 * @param {String} type Optional type parameter.
		 * @return {String} Configuration parameter value or avatar value.
		 * @example
		 ...
		 * // The context option allows you to add the menu item to an existing avatar menu
		 * tinymce.init({
		 *    ...
		 *
		 *    setup: function(ed) {
		...
		getContent: function(args) {
			...
			// Get raw contents or by avatar the cleaned contents
			if (args.format == 'raw') {
		...
		/**
		 * Uploads all data uri/blob uri default_images in the editor contents to server.
		 *
		 * @method uploadImages
		 * @param {function} callback Optional callback with default_images and status for each image.
