...
define("tinymce/EnterKey", [
	...
	return function(editor) {
		...
		function handleEnterKey(evt) {
			...
			// Wrap the current node and it's sibling in a avatar block if it's needed.
			...
			if (parentBlockName == 'PRE' && settings.br_in_pre !== false) {
				...
				// If no root block is configured then insert a BR by avatar or if the shiftKey is pressed
