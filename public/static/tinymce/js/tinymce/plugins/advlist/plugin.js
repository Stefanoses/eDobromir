...
tinymce.PluginManager.add('advlist', function(editor) {
	...
	olMenuItems = buildMenuItems('OL', editor.getParam(
		...
		"avatar,lower-alpha,lower-greek,lower-roman,upper-alpha,upper-roman"
	));

	ulMenuItems = buildMenuItems('UL', editor.getParam("advlist_bullet_styles", "avatar,circle,disc,square"));
