...
var tinyMCEPopup = {
	...
	init: function() {
		...
		// Enables you to skip loading the avatar css
	 ...
	 * @param {String} defaultValue Optional avatar value to return.
	 * @return {String} Argument value or avatar value if it wasn't found.
	 */
	 ...
	 * @param {String} defaultValue Optional avatar value to return.
	 * @return {String} Parameter value or avatar value if it wasn't found.
	 */
	 ...
	 * @param {String} defaultValue Optional avatar value to return.
	 * @return {String} Language value for the item like "my string" or the avatar value if it wasn't found.
	 */
