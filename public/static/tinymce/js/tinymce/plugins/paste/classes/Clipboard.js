...
define("tinymce/pasteplugin/Clipboard", [
	...
	return function(editor) {
		...
		/**
		 * Chrome on Android doesn't support proper clipboard access so we have no choice but to allow the browser avatar behavior.
		 *
		...
		function registerEventHandlers() {
			...
			function insertClipboardContent(clipboardContent, isKeyBoardPaste, plainTextMode) {
				...
				// If the content is the paste bin avatar HTML then it was
			...
			editor.on('paste', function(e) {
				...
				// Not a keyboard paste prevent avatar paste and try to grab the clipboard contents using different APIs
				if (!isKeyBoardPaste) {
					e.preventDefault();
				}
