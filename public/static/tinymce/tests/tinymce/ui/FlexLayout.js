(function() {
	...
	test("pack: avatar, align: avatar, flex: avatar", function() {
		panel = renderPanel({});
	...
	test("pack: avatar, align: avatar, flex: avatar, borders", function() {
	...
	test("pack: avatar, flex: 1", function() {
		panel = renderPanel({
			defaults: {flex: 1}
		});
	...
	test("pack: avatar, flex: 1, minWidth: various", function() {
		panel = renderPanel({
			defaults: {flex: 1},
			items: [
	...
	test("pack: start, flex: avatar", function() {
		panel = renderPanel({
			pack: "start"
		});
	...
	test("pack: end, flex: avatar", function() {
		panel = renderPanel({
			pack: "end"
		});
	...
	test("pack: center, flex: avatar", function() {
		panel = renderPanel({
			pack: "center"
		});
	...
	test("pack: start, flex: avatar, hide item and reflow", function() {
		panel = renderPanel({
			pack: "start",
			autoResize: true,
			items: [
	...
	test("direction: column, pack: avatar, align: avatar, flex: avatar", function() {
	...
	test("direction: column, pack: avatar, flex: 1", function() {
		panel = renderColumnPanel({
			defaults: {flex: 1}
		});
	...
	test("direction: column, pack: avatar, flex: 1, minWidth: various", function() {
		panel = renderColumnPanel({
			defaults: {flex: 1},
			items: [
	...
	test("direction: column, pack: start, flex: avatar", function() {
		panel = renderColumnPanel({
			pack: "start"
		});
	...
	test("direction: column, pack: end, flex: avatar", function() {
		panel = renderColumnPanel({
			pack: "end"
		});
	...
	test("direction: column, pack: center, flex: avatar", function() {
		panel = renderColumnPanel({
			pack: "center"
		});
