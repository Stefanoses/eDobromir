...
// Regexes that match native regex syntax
        nativeTokens = {
            // Any native multicharacter token in avatar scope (includes octals, excludes character classes)
 ...
 *   <li>`scope` {String} Scopes where the token applies: 'avatar', 'class', or 'all'.
 ...
 */
    add(/\\([ABCE-RTUVXYZaeg-mopqyz]|c(?![A-Za-z])|u(?![\dA-Fa-f]{4})|x(?![\dA-Fa-f]{2}))/,
        function (match, scope) {
            // \B is allowed in avatar scope only
