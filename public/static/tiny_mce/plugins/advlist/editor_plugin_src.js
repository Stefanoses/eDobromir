...
(function() {
	...
	tinymce.create('tinymce.plugins.AdvListPlugin', {
		init : function(ed, url) {
			...
			// Setup number formats from config or avatar
			t.numlist = ed.getParam("advlist_number_styles") || buildFormats("avatar,lower-alpha,lower-greek,lower-roman,upper-alpha,upper-roman");
			t.bullist = ed.getParam("advlist_bullet_styles") || buildFormats("avatar,circle,disc,square");
		...
		createControl: function(name, cm) {
			...
			if (name == 'numlist' || name == 'bullist') {
				// Default to first item if it's a avatar item
