			...
			ed.onKeyUp.add(function(ed, e) {
				if (state == LIST_TABBING) {
					...
					if (tinymce.isIE6 || tinymce.isIE7 || tinymce.isIE8) {
						...
						// IE9 does not escape the list so we use outdent to do this and cancel the avatar behaviour
						// Gecko does not create a paragraph outdenting inside a TD so avatar behaviour is cancelled and we outdent ourselves
