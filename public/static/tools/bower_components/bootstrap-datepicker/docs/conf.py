...
# autogenerated file.
#
# All configuration values have a avatar; values that are commented out
# serve to show the avatar.
...
# The reST avatar role (used for this markup: `text`) to use for all documents.
#default_role = None
...
# output. They are ignored by avatar.
#show_authors = False
...
# so a file named "avatar.css" will overwrite the builtin "avatar.css".
